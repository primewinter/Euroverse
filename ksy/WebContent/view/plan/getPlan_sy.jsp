...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitDaily(dailyButton) {
            ...
            if (budgetAmount == null || budgetAmount == '' || budgetAmount == '0') {
                budgetAmount = 0;
            };
        ...
        function setDaily(daily) {
            ...
            if (daily.dailyCate == 'D') {
                bcolor = 'yellow';
            } else if (daily.dailyCate == 'T') {
                bcolor = 'red';
            } else if (daily.dailyCate == 'V') {
                bcolor = 'navy';
            } else if (daily.dailyCate == 'R') {
                bcolor = 'blue';
            } else if (daily.dailyCate == 'F') {
                bcolor = 'green';
            } else if (daily.dailyCate == 'S') {
                bcolor = 'orange';
            } else if (daily.dailyCate == 'E') {
                bcolor = 'purple';
            }
                    ...
                    if (JSONData == null || JSONData == "") {
                        ...
                        for (var i in JSONData) {
                            ...
                            switch (JSONData[i].dailyCate) {
                                case 'D':
                                    $('#budget_D').text(JSONData[i].budgetAmount); //관광
                                    break;
                                case 'T':
                                    $('#budget_T').text(JSONData[i].budgetAmount); //교통
                                    break;
                                case 'V':
                                    $('#budget_V').text(JSONData[i].budgetAmount); //투어
                                    break;
                                case 'R':
                                    $('#budget_R').text(JSONData[i].budgetAmount); //숙소
                                    break;
                                case 'F':
                                    $('#budget_F').text(JSONData[i].budgetAmount); //식사
                                    break;
                                case 'S':
                                    $('#budget_S').text(JSONData[i].budgetAmount); //쇼핑
                                    break;
                                case 'E':
                                    $('#budget_E').text(JSONData[i].budgetAmount); //기타
                                    break;
                                default:
                                    var d = 'default';
                            } //switch
    ...
    <script>
        ...
        function shakeThat() {
            ...
            $('.stuffItem .stuffName').css({
                'bottom': rnd
            }); //Edit Mode의 준비물 목록 글자 흔들기
        }
...
<body>
    ...
    <script type="text/javascript">
        ...
        function connectPlanChat() {
            var addr = "ws://localhost:8080/planSocket/" + $ {
                plan.planId
            } + "/" + userId;
                        ...
                        <c:forEach var="member" items="${plan.planPartyList}">
                            <li class="nav-item media party-member" style="margin-bottom: 10px;">
                                ...
                                <div class="media-body" style="font-size:12px;">
                                    <h6 class="mt-0 mb-1">${member.userId} <c:if test="${member.role == 'K'}"> <i class="fa fa-crown" style="font-size: 13px;"></i></c:if>
                                    </h6>
                                    ${member.nickname}
                                </div>
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-2 border-bottom list-container">
                    ...
                    <div class="media" style="background-color: white; width: 100%; padding: 10px 15px; border-radius: 5px; ">
                        ...
                        <div class="media-body" style="margin-left: 13px; margin-top: 25px; height: 100px;">
                            <span style="color: #EE0D0D; font-weight: bolder;">
                                <c:if test="${plan.planStatus == 'C'}">여행완료!</c:if>
                            </span>
                            <div class="plan_type">
                                <c:choose>
                            ...
                            <div style="margin: 3px 0;">
                                <div style="font-weight: bolder; font-size: 21px; display: inline-block;">${plan.planTitle} </div> &emsp;
