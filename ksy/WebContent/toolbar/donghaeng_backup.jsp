        ...
        function receiveAccChat(chat) {
            ...
            if(chat.senderId == 'system'){
                ...
                html += "<div class=\"chat mine\">"
               	...
               	html += "<font color='#cccccc' size=1 class='mine msg sendTime'>"+chat.sendTime+"</font>";
                html += "<span class='bubble mine'>";
                ...
                html += "<span class='bubble other'>";
                html += "<font color='black' size=2 class='other msg content'>"+chat.chatContent+"</font>";
                html += "</span>"
                html += "<font color='#cccccc' size=1 class='other msg sendTime'>"+chat.sendTime+"</font>";
                html += "</div>"
