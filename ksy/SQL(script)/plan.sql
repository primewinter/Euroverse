...
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '자그레브', '크로아티아', '도시정보', 'city_img.jpg', 45.8403496,15.8242479, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '에이일스타디르', '아이슬란드', '에이일스스타디르는 아이슬란드 동부에 위치한 도시로, 인구는 2,257명이다.', 'city_img.jpg', 65.2623726,-14.4148883, 1  );


INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '누크', '그린란드', '누크 또는 고트호프는 그린란드의 수도이자 최대도시이며, 1979년에 발족한 그린란드의 자치 정부가 위치해 있는 곳이다.', 'city_img.jpg', 64.3517529,-45.5152857, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '밀라노', '이탈리아', '밀라노 도시정보', 'city_img.jpg', 45.4628329,9.1076924, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '나폴리', '이탈리아', '나폴리 도시정보', 'city_img.jpg', 40.8540421,14.1765624, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '베른', '스위스', '베른은 스위스의 연방시이며 사실상 수도이다. 취리히, 제네바, 바젤에 이어 스위스에서 네 번째로 큰 도시이기도 하다.', 'city_img.jpg', 46.9547658,7.3248302, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '루체른', '스위스', '도시정보', 'city_img.jpg', 47.0548081,8.2472856, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '그린델발트', '스위스', '그린델발트는 스위스 베른주에 위치한 도시로 면적은 171.08km², 높이는 1,034m, 인구는 3,740명, 인구 밀도는 22명/km²이다.', 'city_img.jpg', 46.6197715,7.9707351, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '라우터브루넨', '스위스', '라우터브루넨는 스위스 베른주에 위치한 도시로, 면적은 164.56km², 높이는 795m, 인구는 2,558명, 인구 밀도는 16명/km²이다. 빙하의 침식으로 인해 형성된 빙하곡과 접해 있으며 70여 개가 넘는 골짜기와 폭포로 유명한 도시이다.', 'city_img.jpg', 46.5533016,7.8367102, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '잘츠부르크', '오스트리아', '도시정보', 'city_img.jpg', 47.802904,12.9863902, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '할슈타트', '오스트리아', '도시정보', 'city_img.jpg', 47.5345646,13.5405902, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '리옹', '프랑스', '리옹은 프랑스의 도시로 론주와 론알프 지방의 중심도시이며, 과거 앙시앵 레짐의 프로방스 리오네의 중심지였다.', 'city_img.jpg', 45.7580539,4.7650811, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '마르세유', '프랑스', '마르세유는 프랑스에서 두 번째로 큰 도시이다. 프로방스알프코트다쥐르 레지옹과 부슈뒤론주의 중심지이기도 하다.', 'city_img.jpg', 43.280555,5.2404125, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '보르도', '프랑스', '보르도는 프랑스 남서부에 있는 항구 도시이다. 보르도는 아키텐 레지옹의 주도이자, 지롱드주의 주도이다.', 'city_img.jpg', 44.8638282,-0.6561809, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '세비야', '스페인', '세비야는 스페인의 남서부에 있는 도시로, 안달루시아 지방의 예술, 문화, 금융의 중심 도시이며 세비야 주의 주도이다.', 'city_img.jpg', 37.3754865,-6.0250983, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '그라나다', '스페인', '그라나다는 스페인 안달루시아 지방에 위치한 그라나다 주의 주도이다.', 'city_img.jpg', 37.1810095,-3.6262912, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '발렌시아', '스페인', '발렌시아는 스페인 발렌시아 주의 주도이다.', 'city_img.jpg', 39.4079665,-0.5015958, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '리버풀', '영국', '리버풀은 잉글랜드 북서부의 도시로 2015년 기준으로 인구는 478,580 명이다. 머지 강 어귀의 동쪽에 자리잡고 있다.', 'city_img.jpg', 53.4123001,-3.0561414, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '브라이턴', '영국', '브라이턴은 영국 잉글랜드 남동부 이스트서식스주 서단에 위치한 마을로 브라이턴앤드호브의 일부이다.', 'city_img.jpg', 50.8374669,-0.1412091, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '도버', '영국', '도버는 영국 잉글랜드 켄트주의 항구 도시이다.', 'city_img.jpg', 51.126333,1.2659699, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '바스', '영국', '바스 또는 배스는 영국 잉글랜드의 남서부 서머싯주에 위치한 도시로, 런던에서 서쪽으로 156 킬로미터와 브리스틀에서 남동쪽으로 21 킬로미터 떨어진 곳에 있다.', 'city_img.jpg', 51.3801748,-2.3995494, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '카디프', '영국', '카디프는 웨일스의 수도이자 웨일스에서 가장 많은 인구가 사는 도시로, 영국에서 9번째로 인구가 많은 도시이다.', 'city_img.jpg', 51.5023268,-3.2750897, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '에든버러', '영국', '에든버러는 스코틀랜드의 수도이며, 글래스고 다음으로 큰 도시다.', 'city_img.jpg', 55.9412846,-3.2753782, 1  );



INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '뮌헨', '독일', '뮌헨은 독일 바이에른주의 최대 도시이자 주도시이다. 이 도시는 알프스 북부의 이자르 강가에 위치한다.', 'city_img.jpg', 48.1550547,11.4017524, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '드레스덴', '독일', '드레스덴은 독일 동부에 위치한 작센주의 주도로 엘베 강변에 위치해 있다.', 'city_img.jpg', 51.0769658,13.6325027, 1  );

INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '쾰른', '독일', '쾰른은 독일 노르트라인베스트팔렌주의 도시다. 베를린, 함부르크, 뮌헨에 이어 독일에서 가장 큰 도시로 옛 프로이센에서는 베를린 다음으로 제2의 도시였다.', 'city_img.jpg', 50.9578353,6.8272394, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '뉘른베르크', '독일', '뉘른베르크는 독일 바이에른주에 있는 도시이다. 인구는 약 50만 명 이상이며 바이에른 주에서는 뮌헨에 이어 2번째로 큰 도시이다.', 'city_img.jpg', 49.4362322,10.9929541, 1  );
...
INSERT INTO city_info ( city_info_id, city_name, country, city_content, city_img, lat, lng, scroll_scale )
VALUES ( TO_CHAR(seq_city_info_city_info_id.nextval), '포르토', '포르투갈', '포르투 는 포르투갈 북부의 항구 도시로 포르투갈 제2의 도시이다.', 'city_img.jpg', 41.1622023,-8.6569731, 1  );
